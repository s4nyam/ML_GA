...
if(int(0.2 * population_size) ) >= 1:
  tournament_selection_size = int(0.2 * population_size)
else:
...
plt.legend()
plt.savefig("genetic_algorithm_v13_running_for_100bits_0_25mutationrate_10populationsize_0_5eliteindividuals_0_5touranmentselection.png")
plt.show()
